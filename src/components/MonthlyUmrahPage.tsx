...
export function MonthlyUmrahPage({ onBack, onFormSubmitted }: MonthlyUmrahPageProps) {
  ...
  const packages = [
    {
      ...
      duration: '5 Days',
      price: { usd: '$2,200', naira: '₦3,300,000' },
      features: ['3-star accommodation', 'Group guidance', 'Transportation', 'Visa processing', 'Basic meals']
    },
    {
      name: 'Executive Package',
      duration: '5 Days',
      price: { usd: '$3,500', naira: '₦5,250,000' },
      features: ['4-star accommodation', 'Private guidance', 'VIP transportation', 'Visa processing', 'Premium meals', 'Airport lounge access']
    }
  ];

  const handleBookPackage = (pkg: any) => {
    const packageDetails = {
      service: 'Monthly Umrah',
      package: pkg.name,
      price: pkg.price
    };
      ...
      <div className="relative overflow-hidden py-16 sm:py-32">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl text-black/80 max-w-4xl mx-auto leading-relaxed"
          >
            Regular monthly Umrah packages available year-round with flexible dates and comprehensive services.
          </motion.p>
        </div>
      </div>
